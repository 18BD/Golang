...
func (c *pingServiceClient) Ping(ctx context.Context, in *PingMessage, opts ...grpc.CallOption) (*PingMessage, error) {
	out := new(PingMessage)
	err := c.cc.Invoke(ctx, "/libraryService.PingService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingServiceServer) Ping(context.Context, *PingMessage) (*PingMessage, error) {
...
func _PingService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/libraryService.PingService/Ping",
	}
...
var PingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "libraryService.PingService",
	...
	Metadata: "protoFiles/ping.proto",
}
